<template>
  <div class="component-upload-image">
    <div v-if="video" class="videoBox">
      <i class="icon-close" @click="handleRemove"></i>
      <video :src="videoUrl" class="video" controls="controls"></video>
    </div>
    <el-upload
      v-else
      multiple
...
export default {
  ...
  data() {
    return {
      ...
      uploadImgUrl: process.env.VUE_APP_BASE_API + "/common/upload", // 上传的服务器地址
      headers: {
