	...
	<div class="app-container">
		...
		<el-dialog :title="title" :visible.sync="open" append-to-body>
			<el-form ref="form" :model="form" :rules="rules" label-width="90px">
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="网格权限">
							<treeselect :multiple="true" :options="gridOptions" placeholder="请选择网格权限:" v-model="form.areaIds" :normalizer="normalizer" :show-count="true" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="党组织权限">
							<treeselect :multiple="true" :options="partyOptions" placeholder="请选择" v-model="form.partyIds" :normalizer="normalizer" :show-count="true" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="身份证号" prop="cardId">
							<el-input v-model="form.cardId" placeholder="请输入身份证号" maxlength="30" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script>
	...
	import { partyTree } from "@/api/area/partymember";
		...
		methods: {
			...
			handleUpdate(row) {
				...
				getUser(userId).then(response => {
					...
					let gridArray = response.data.areaIds
					this.form.areaIds = gridArray.map(Number);
